export type BuiltinMoodTag='happy'|'anxious'|'tired'|'angry'|'calm'; export type MoodTag=BuiltinMoodTag|(string&{}); export type AssessmentCategory='anxiety'|'depression'|'stress'|'sleep';
...
export interface CustomMoodTag {id:number;user_id:number;name:string;is_active:boolean;created_at:string}
