export type MoodTag=string; export type AssessmentCategory='anxiety'|'depression'|'stress'|'sleep';
...
export interface MoodTagDef {id:number;user_id:number;name:string;is_active:boolean;created_at:string;updated_at:string}
